...
@Configuration
@EnableJpaRepositories("com.environment.environment.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.environment.environment.config.HerokuDatabaseConfiguration")
